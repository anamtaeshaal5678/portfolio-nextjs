...
const skills = () => {
    return (
        <div>
            ...
            <section className="text-black bg-cyan-300 body-font">
                <div className="container px-5 py-24 mx-auto">
                    <div className="flex flex-col text-center w-full mb-20">
                        <h2 className="text-xl text-black tracking-widest font-extrabold  bg-cyan-300 title-font mb-1">
                            Skills
                        </h2>
                        <h1 className=":text-3xl text-2xl font-extrabold title-font text-black">
                            MY Skills
                        </h1>
                    </div>
